...
function add_css$1(target) {
	append_styles(target, "svelte-lu2di2-Content", ".icon.svelte-lu2di2-Content{position:relative;overflow:hidden;vertical-align:middle;-o-object-fit:contain;object-fit:contain;transform-origin:center center;stroke:currentColor;stroke-width:1;stroke-linecap:round;stroke-linejoin:round;fill:currentColor}");
}
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			attr(svg, "class", "icon  svelte-lu2di2-Content");
		},
		m(target, anchor) {
...
function add_css(target) {
	append_styles(target, "svelte-iycx9t-Content", ".svelte-iycx9t-Content,.svelte-iycx9t-Content::before,.svelte-iycx9t-Content::after{box-sizing:border-box;border-width:0;border-style:solid;border-color:#E5E7EB}.svelte-iycx9t-Content::before,.svelte-iycx9t-Content::after{--tw-content:''}.svelte-iycx9t-Content:-moz-focusring{outline:auto}.svelte-iycx9t-Content:-moz-ui-invalid{box-shadow:none}.svelte-iycx9t-Content::-webkit-inner-spin-button,.svelte-iycx9t-Content::-webkit-outer-spin-button{height:auto}.svelte-iycx9t-Content::-webkit-search-decoration{-webkit-appearance:none}.svelte-iycx9t-Content::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}.svelte-iycx9t-Content:disabled{cursor:default}.svelte-iycx9t-Content::-webkit-datetime-edit-fields-wrapper{padding:0}.svelte-iycx9t-Content::-webkit-date-and-time-value{min-height:1.5em}.svelte-iycx9t-Content{font-family:ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\"}.svelte-iycx9t-Content,.svelte-iycx9t-Content::before,.svelte-iycx9t-Content::after{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(63 131 248 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  }.svelte-iycx9t-Content::-webkit-backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(63 131 248 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  }.svelte-iycx9t-Content::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(63 131 248 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  }@media(min-width: 640px){}@media(min-width: 768px){}@media(min-width: 1024px){}@media(min-width: 1280px){}@media(min-width: 1536px){}.m-2.svelte-iycx9t-Content{margin:0.5rem}.flex.svelte-iycx9t-Content{display:flex}.h-8.svelte-iycx9t-Content{height:2rem}.w-8.svelte-iycx9t-Content{width:2rem}@-webkit-keyframes svelte-iycx9t-Content-spin{to{transform:rotate(360deg)}}@keyframes svelte-iycx9t-Content-spin{to{transform:rotate(360deg)}}.items-center.svelte-iycx9t-Content{align-items:center}.justify-center.svelte-iycx9t-Content{justify-content:center}.bg-contain.svelte-iycx9t-Content{background-size:contain}.bg-no-repeat.svelte-iycx9t-Content{background-repeat:no-repeat}.text-center.svelte-iycx9t-Content{text-align:center}.align-middle.svelte-iycx9t-Content{vertical-align:middle}.text-slate-500.svelte-iycx9t-Content{--tw-text-opacity:1;color:rgb(100 116 139 / var(--tw-text-opacity))}@media(min-width: 640px){}@media(min-width: 768px){}@media(min-width: 1024px){}@media(min-width: 1280px){}@media(min-width: 1536px){}");
}
...
function fallback_block(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "text-slate-500 svelte-iycx9t-Content");
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			div1 = element("div");
			if (default_slot) default_slot.c();
			attr(div0, "class", "align-middle w-8 h-8 svelte-iycx9t-Content");
			attr(div1, "class", "align-middle svelte-iycx9t-Content");
			attr(div2, "class", "flex align-middle items-center text-center justify-center bg-contain bg-no-repeat m-2 biggie svelte-iycx9t-Content");
		},
		m(target, anchor) {
