...
function add_css$2(target) {
	append_styles(target, "svelte-cocecf-ContextMenu", ".icon.svelte-cocecf-ContextMenu{position:relative;overflow:hidden;vertical-align:middle;-o-object-fit:contain;object-fit:contain;transform-origin:center center;stroke:currentColor;stroke-width:1;stroke-linecap:round;stroke-linejoin:round;fill:currentColor}");
}
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(svg, "class", "icon  svelte-cocecf-ContextMenu");
		},
		m(target, anchor) {
...
function add_css$1(target) {
	append_styles(target, "svelte-mb9bsm-ContextMenu", ".svelte-mb9bsm-ContextMenu,.svelte-mb9bsm-ContextMenu::before,.svelte-mb9bsm-ContextMenu::after{box-sizing:border-box;border-width:0;border-style:solid;border-color:#E5E7EB}.svelte-mb9bsm-ContextMenu::before,.svelte-mb9bsm-ContextMenu::after{--tw-content:''}.svelte-mb9bsm-ContextMenu:-moz-focusring{outline:auto}.svelte-mb9bsm-ContextMenu:-moz-ui-invalid{box-shadow:none}.svelte-mb9bsm-ContextMenu::-webkit-inner-spin-button,.svelte-mb9bsm-ContextMenu::-webkit-outer-spin-button{height:auto}.svelte-mb9bsm-ContextMenu::-webkit-search-decoration{-webkit-appearance:none}.svelte-mb9bsm-ContextMenu::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}.svelte-mb9bsm-ContextMenu:disabled{cursor:default}.svelte-mb9bsm-ContextMenu::-webkit-datetime-edit-fields-wrapper{padding:0}.svelte-mb9bsm-ContextMenu::-webkit-date-and-time-value{min-height:1.5em}.svelte-mb9bsm-ContextMenu{font-family:ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\"}.svelte-mb9bsm-ContextMenu,.svelte-mb9bsm-ContextMenu::before,.svelte-mb9bsm-ContextMenu::after{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(63 131 248 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  }.svelte-mb9bsm-ContextMenu::-webkit-backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(63 131 248 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  }.svelte-mb9bsm-ContextMenu::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(63 131 248 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  }@media(min-width: 640px){}@media(min-width: 768px){}@media(min-width: 1024px){}@media(min-width: 1280px){}@media(min-width: 1536px){}.m-2.svelte-mb9bsm-ContextMenu{margin:0.5rem}.flex.svelte-mb9bsm-ContextMenu{display:flex}.h-8.svelte-mb9bsm-ContextMenu{height:2rem}.w-8.svelte-mb9bsm-ContextMenu{width:2rem}@-webkit-keyframes svelte-mb9bsm-ContextMenu-spin{to{transform:rotate(360deg)}}@keyframes svelte-mb9bsm-ContextMenu-spin{to{transform:rotate(360deg)}}.items-center.svelte-mb9bsm-ContextMenu{align-items:center}.justify-center.svelte-mb9bsm-ContextMenu{justify-content:center}.bg-contain.svelte-mb9bsm-ContextMenu{background-size:contain}.bg-no-repeat.svelte-mb9bsm-ContextMenu{background-repeat:no-repeat}.text-center.svelte-mb9bsm-ContextMenu{text-align:center}.align-middle.svelte-mb9bsm-ContextMenu{vertical-align:middle}.text-slate-500.svelte-mb9bsm-ContextMenu{--tw-text-opacity:1;color:rgb(100 116 139 / var(--tw-text-opacity))}@media(min-width: 640px){}@media(min-width: 768px){}@media(min-width: 1024px){}@media(min-width: 1280px){}@media(min-width: 1536px){}");
}
...
function fallback_block(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "text-slate-500 svelte-mb9bsm-ContextMenu");
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			div1 = element("div");
			if (default_slot) default_slot.c();
			attr(div0, "class", "align-middle w-8 h-8 svelte-mb9bsm-ContextMenu");
			attr(div1, "class", "align-middle svelte-mb9bsm-ContextMenu");
			attr(div2, "class", "flex align-middle items-center text-center justify-center bg-contain bg-no-repeat m-2 biggie svelte-mb9bsm-ContextMenu");
		},
		m(target, anchor) {
...
function add_css(target) {
	append_styles(target, "svelte-1isf3sd-ContextMenu", ".svelte-1isf3sd-ContextMenu,.svelte-1isf3sd-ContextMenu::before,.svelte-1isf3sd-ContextMenu::after{box-sizing:border-box;border-width:0;border-style:solid;border-color:#E5E7EB}.svelte-1isf3sd-ContextMenu::before,.svelte-1isf3sd-ContextMenu::after{--tw-content:''}b.svelte-1isf3sd-ContextMenu{font-weight:bolder}input.svelte-1isf3sd-ContextMenu{font-family:inherit;font-size:100%;font-weight:inherit;line-height:inherit;color:inherit;margin:0;padding:0}.svelte-1isf3sd-ContextMenu:-moz-focusring{outline:auto}.svelte-1isf3sd-ContextMenu:-moz-ui-invalid{box-shadow:none}.svelte-1isf3sd-ContextMenu::-webkit-inner-spin-button,.svelte-1isf3sd-ContextMenu::-webkit-outer-spin-button{height:auto}.svelte-1isf3sd-ContextMenu::-webkit-search-decoration{-webkit-appearance:none}.svelte-1isf3sd-ContextMenu::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}input.svelte-1isf3sd-ContextMenu::-moz-placeholder{opacity:1;color:#9CA3AF}input.svelte-1isf3sd-ContextMenu::placeholder{opacity:1;color:#9CA3AF}.svelte-1isf3sd-ContextMenu:disabled{cursor:default}svg.svelte-1isf3sd-ContextMenu{display:block;vertical-align:middle}[type='text'].svelte-1isf3sd-ContextMenu{-webkit-appearance:none;-moz-appearance:none;appearance:none;background-color:#fff;border-color:#6B7280;border-width:1px;border-radius:0px;padding-top:0.5rem;padding-right:0.75rem;padding-bottom:0.5rem;padding-left:0.75rem;font-size:1rem;line-height:1.5rem;--tw-shadow:0 0 #0000}[type='text'].svelte-1isf3sd-ContextMenu:focus{outline:2px solid transparent;outline-offset:2px;--tw-ring-inset:var(--tw-empty,/*!*/ /*!*/);--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:#1C64F2;--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(1px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow);border-color:#1C64F2}input.svelte-1isf3sd-ContextMenu::-moz-placeholder{color:#6B7280;opacity:1}input.svelte-1isf3sd-ContextMenu::placeholder{color:#6B7280;opacity:1}.svelte-1isf3sd-ContextMenu::-webkit-datetime-edit-fields-wrapper{padding:0}.svelte-1isf3sd-ContextMenu::-webkit-date-and-time-value{min-height:1.5em}[type='checkbox'].svelte-1isf3sd-ContextMenu{-webkit-appearance:none;-moz-appearance:none;appearance:none;padding:0;-webkit-print-color-adjust:exact;color-adjust:exact;print-color-adjust:exact;display:inline-block;vertical-align:middle;background-origin:border-box;-webkit-user-select:none;-moz-user-select:none;user-select:none;flex-shrink:0;height:1rem;width:1rem;color:#1C64F2;background-color:#fff;border-color:#6B7280;border-width:1px;--tw-shadow:0 0 #0000}[type='checkbox'].svelte-1isf3sd-ContextMenu{border-radius:0px}[type='checkbox'].svelte-1isf3sd-ContextMenu:focus{outline:2px solid transparent;outline-offset:2px;--tw-ring-inset:var(--tw-empty,/*!*/ /*!*/);--tw-ring-offset-width:2px;--tw-ring-offset-color:#fff;--tw-ring-color:#1C64F2;--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow)}[type='checkbox'].svelte-1isf3sd-ContextMenu:checked{border-color:transparent;background-color:currentColor;background-size:100% 100%;background-position:center;background-repeat:no-repeat}[type='checkbox'].svelte-1isf3sd-ContextMenu:checked{background-image:url(\"data:image/svg+xml,%3csvg viewBox='0 0 16 16' fill='white' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M12.207 4.793a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0l-2-2a1 1 0 011.414-1.414L6.5 9.086l4.293-4.293a1 1 0 011.414 0z'/%3e%3c/svg%3e\")}[type='checkbox'].svelte-1isf3sd-ContextMenu:indeterminate{background-image:url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 16 16'%3e%3cpath stroke='white' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M4 8h8'/%3e%3c/svg%3e\");border-color:transparent;background-color:currentColor;background-size:100% 100%;background-position:center;background-repeat:no-repeat}[type='checkbox'].svelte-1isf3sd-ContextMenu:indeterminate:hover,[type='checkbox'].svelte-1isf3sd-ContextMenu:indeterminate:focus{border-color:transparent;background-color:currentColor}.svelte-1isf3sd-ContextMenu{font-family:ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\"}.svelte-1isf3sd-ContextMenu,.svelte-1isf3sd-ContextMenu::before,.svelte-1isf3sd-ContextMenu::after{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(63 131 248 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  }.svelte-1isf3sd-ContextMenu::-webkit-backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(63 131 248 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  }.svelte-1isf3sd-ContextMenu::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(63 131 248 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  }@media(min-width: 640px){}@media(min-width: 768px){}@media(min-width: 1024px){}@media(min-width: 1280px){}@media(min-width: 1536px){}.z-50.svelte-1isf3sd-ContextMenu{z-index:50}.mx-4.svelte-1isf3sd-ContextMenu{margin-left:1rem;margin-right:1rem}.mx-1.svelte-1isf3sd-ContextMenu{margin-left:0.25rem;margin-right:0.25rem}.flex.svelte-1isf3sd-ContextMenu{display:flex}.h-10.svelte-1isf3sd-ContextMenu{height:2.5rem}.w-10.svelte-1isf3sd-ContextMenu{width:2.5rem}@-webkit-keyframes svelte-1isf3sd-ContextMenu-spin{to{transform:rotate(360deg)}}@keyframes svelte-1isf3sd-ContextMenu-spin{to{transform:rotate(360deg)}}.flex-row.svelte-1isf3sd-ContextMenu{flex-direction:row}.flex-col.svelte-1isf3sd-ContextMenu{flex-direction:column}.justify-end.svelte-1isf3sd-ContextMenu{justify-content:flex-end}.rounded-sm.svelte-1isf3sd-ContextMenu{border-radius:0.125rem}.border.svelte-1isf3sd-ContextMenu{border-width:1px}.border-slate-300.svelte-1isf3sd-ContextMenu{--tw-border-opacity:1;border-color:rgb(203 213 225 / var(--tw-border-opacity))}.bg-slate-50.svelte-1isf3sd-ContextMenu{--tw-bg-opacity:1;background-color:rgb(248 250 252 / var(--tw-bg-opacity))}.p-4.svelte-1isf3sd-ContextMenu{padding:1rem}.text-left.svelte-1isf3sd-ContextMenu{text-align:left}.text-sm.svelte-1isf3sd-ContextMenu{font-size:0.875rem;line-height:1.25rem}.text-lg.svelte-1isf3sd-ContextMenu{font-size:1.125rem;line-height:1.75rem}.drop-shadow-lg.svelte-1isf3sd-ContextMenu{--tw-drop-shadow:drop-shadow(0 10px 8px rgb(0 0 0 / 0.04)) drop-shadow(0 4px 3px rgb(0 0 0 / 0.1));filter:var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)}@media(min-width: 640px){}@media(min-width: 768px){}@media(min-width: 1024px){}@media(min-width: 1280px){}@media(min-width: 1536px){}");
}
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			div0 = element("div");
			if_block.c();
			attr(div0, "class", "text-left border-slate-300 svelte-1isf3sd-ContextMenu");
			attr(div1, "class", "flex flex-row justify-end z-50 bg-slate-50 border drop-shadow-lg p-4 mx-4 rounded-sm svelte-1isf3sd-ContextMenu");
		},
		m(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			span = element("span");
			span.innerHTML = `Paste the <b class="svelte-1isf3sd-ContextMenu">Public Key</b> you want to grant access`;
			t3 = space();
			create_component(content0.$$.fragment);
			t4 = space();
			create_component(content1.$$.fragment);
			attr(span, "class", "text-sm svelte-1isf3sd-ContextMenu");
		},
		m(target, anchor) {
...
function create_default_slot_1(ctx) {
	...
	return {
		c() {
			...
			attr(input, "class", "svelte-1isf3sd-ContextMenu");
		},
		m(target, anchor) {
...
function create_first_slot_1(ctx) {
	...
	return {
		c() {
			...
			attr(span, "class", "text-sm mx-1 text-lg svelte-1isf3sd-ContextMenu");
		},
		m(target, anchor) {
			insert(target, span, anchor);
		},
...
function create_first_slot(ctx) {
	...
	return {
		c() {
			...
			t0 = space();
			span = element("span");
			span.innerHTML = `Add <b class="svelte-1isf3sd-ContextMenu">Contact</b>`;
			attr(input, "type", "checkbox");
			input.checked = true;
			attr(input, "class", "svelte-1isf3sd-ContextMenu");
			attr(span, "class", "text-sm mx-1 svelte-1isf3sd-ContextMenu");
		},
		m(target, anchor) {
			insert(target, input, anchor);
			insert(target, t0, anchor);
