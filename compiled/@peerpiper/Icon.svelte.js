...
function add_css(target) {
	append_styles(target, "svelte-806qjn-Icon", ".icon.svelte-806qjn-Icon{position:relative;overflow:hidden;vertical-align:middle;-o-object-fit:contain;object-fit:contain;transform-origin:center center;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;fill:currentColor}");
}
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(svg, "class", "icon  svelte-806qjn-Icon");
		},
		m(target, anchor) {
